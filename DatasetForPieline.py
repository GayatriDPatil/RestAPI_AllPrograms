...
BODY = {
  "properties": {
    ...
    "typeProperties": {
      "folderPath": {
        "value": "@dataset()./home/admin1/Desktop/Gayatri/API_All/venv/input",
        "type": "Expression"
      },
      "fileName": {
        "value": "@dataset()./home/admin1/Desktop/Gayatri/API_All/venv/input/Google_Stock_Price_Train.csv",
        "type": "Expression"
      },
      "format": {
        "type": "TextFormat"
    ...
    "linkedServiceName": {
      "referenceName": "APILinkedservice1",
