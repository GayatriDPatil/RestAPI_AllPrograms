...
LINKEDSERVICE_NAME = "APILinkedservice1"
...
BODY = {
    "properties": {
        ...
        "typeProperties": {
            "connectionString": {
                "type": "SecureString",
                "value": "DefaultEndpointsProtocol=https;AccountName=gayatristorageacc;AccountKey=7nJAsF+fSodJZ6tP6bh+9hd6RM+5LNxTcakvA/5prd4amPeJKX75thBtHTGbdrqyXOWZGM4at+9xo5OE5lfm9g=="
            }
        }
    }
}
